...
"margin-right: 1275px;\n"
"")
        self.openshopbutton = QPushButton(self.centralwidget)
        self.openshopbutton.setObjectName(u"openshopbutton")
        self.openshopbutton.setGeometry(QRect(88, 385, 1782, 114))
        self.myordercontainer = QWidget(self.centralwidget)
        self.myordercontainer.setObjectName(u"myordercontainer")
        self.myordercontainer.setGeometry(QRect(88, 550, 1782, 237))
        self.favcontainer = QWidget(self.centralwidget)
        self.favcontainer.setObjectName(u"favcontainer")
        self.favcontainer.setGeometry(QRect(88, 787, 1782, 691))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.openshopbutton.setText(QCoreApplication.translate("MainWindow", u"Open Your Shop", None))
    # retranslateUi
